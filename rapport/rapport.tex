...
Nous nous sommes finalement tournés vers le pavage hexagonal qui combine plusieurs avantages : il a plus d'axe que le pavage rectangulaire n'a pas le problème de continuité du triangle.
...
Pour terminer, nous pourrions ajouter une fonctionnalité permettant de retracer un dessin en fonction d'un fichier MIDI.\\
